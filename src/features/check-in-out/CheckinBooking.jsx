...
import { useCheckin } from "./CheckingHooks";
import { useSettings } from "../settings/SettingsHooks";
      ...
      {!hasBreakfast && (
        <Box>
          <Checkbox
            ...
            id="AddBreakfastCheck"
          >
            Do {guests.fullName} wants to add breakfast to the booking for{" "}
